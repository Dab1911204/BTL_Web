...
<body>
  ...
  <div class="main-panel">
    ...
    <?php
    include 'ketnoi.php';
    $sql_layncc = "SELECT COUNT(*) as total FROM sanpham";
      ...
      <table class="table">
        <thead class="thead-dark">
          <tr>
            ...
            <th>Đơn giá</th>
            <th>Tình trạng</th>
            <th style="max-width: 100px;">Mô tả sản phẩm</th>
            <th>Ảnh sản phẩm</th>
            <th>Thao tác</th>
          </tr>
        </thead>
        <tbody id="body_table">
          ...
          // câu lệnh
          $sql = "SELECT *FROM sanpham order by maSanPham DESC limit $start,$item_page";
          // thực thi câu lệnh
          ...
          ?>
            ...
            <tr>
              ...
              <td><img class="img-responsive" src="/Demo/imgchung/<?php echo $row['anhSanPham'] ?>" width=150px height=100px alt=""></td>

              <td> <a href="suasanpham.php?id= <?php echo $row['maSanPham']; ?>" class="btn btn-info">Sửa</a>
                <a onclick="return confirm('Bạn có muốn xóa sản phẩm này không');" href="xoasanpham.php?id=<?php echo $row['maSanPham']; ?>" class="btn btn-danger">Xóa</a>
              </td>
            </tr>
          <?php
          }
