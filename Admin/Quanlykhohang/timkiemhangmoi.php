...
if ($keysearch == "") {
    $query = "select * from khohang where tinhTrang = 'Hàng mới' LIMIT $start, $records_per_page";
} else {
    $query = "select * from khohang where tenSanPham like '%$keysearch%' and tinhTrang = 'Hàng mới' LIMIT $start, $records_per_page";
}
$html = '';
