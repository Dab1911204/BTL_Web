  ...
  <div class="wrapper">
    ...
    <div class="main-panel">
      <div class="container m-3">
        <h1 align="Center">Kho hàng mới</h1>
        <?php
        include 'connect.php';
        $sql_layncc = "SELECT COUNT(*) as total FROM khohang WHERE tinhTrang = 'Hàng mới'";
        ...
        <div class="khoangCach">
          ...
          <div>
            ...
            <a href="hangTon.php" class="btn btn-success mb-3"> Hàng tồn</a>
        ...
        <table class="table">
          ...
          <tbody id="body_table">
            ...
            include 'connect.php';
            // câu lệnh
            $sql = "SELECT *FROM khohang WHERE tinhTrang = 'Hàng mới' LIMIT $start, $item_page  ";
            // thực thi câu lệnh
...
<script type='text/javascript'>
  ...
  inputField.addEventListener('input', function() {
    ...
    ajax_request.open('POST', 'timkiemhangmoi.php');
