...
if ($keysearch == "") {
    $query = "select * from khohang wher    e tinhTrang = 'Hàng cũ' LIMIT $start, $records_per_page";
} else {
    $query = "select * from khohang where tenSanPham like '%$keysearch%' and tinhTrang = 'Hàng cũ' LIMIT $start, $records_per_page";
}
$html = '';
