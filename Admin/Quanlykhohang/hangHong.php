  ...
  <div class="wrapper">
    ...
    <div class="main-panel">
      <div class="container m-3">
        <h1 align="Center">Kho hàng hỏng</h1>
        <?php
        include 'connect.php';
        $sql_layncc = "SELECT COUNT(*) as total FROM khohang  WHERE tinhTrang = 'Hỏng'";
        ...
        <table class="table">
          ...
          <tbody id="body_table">
            ...
            include 'connect.php';
            // câu lệnh
            $sql = "SELECT * FROM khohang WHERE tinhTrang = 'Hỏng' LIMIT $start, $item_page";
            // thực thi câu lệnh
...
<script type='text/javascript'>
  ...
  inputField.addEventListener('input', function() {
    ...
    ajax_request.open('POST', 'timkiemhanghong.php');
