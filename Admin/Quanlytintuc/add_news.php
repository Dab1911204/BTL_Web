...
<body>
  ...
  if (isset($_POST['submit'])) {
    ...
    move_uploaded_file($hinhanh_tmp_name, '/XAMPP/htdocs/Demo/imgchung/' . $hinhanh_name);
    // viết lệnh sql để thêm dữ liệu
    $sql = "INSERT INTO tintuc (tieuDe, noiDung, anhTinTuc, ngayThang, maNhanVien)VALUES ('$tieude', '$noidung', '$hinhanh_name', '$date', 'NV1')";
    ...
    <div class="container">
      ...
      <form action="add_news.php" method="POST" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <textarea type="" name="noidung" class="form-control" required>
                    </textarea>
        </div>
