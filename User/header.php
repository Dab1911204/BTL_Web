        ...
        <div class="main-header">
            <div class="container">
                <div class="row">
                    ...
                    <?php
                    $sql_ten_tai_khoan = "SELECT * FROM khachhang WHERE maKhachHang= '$maKhachhang'";
                    $ket_qua_ten_tai_khoan = mysqli_query($conn, $sql_ten_tai_khoan);
                    $tenTK = mysqli_fetch_assoc($ket_qua_ten_tai_khoan);
                    ?>
                    <div class="col-xs-12 col-sm-12 col-md-3 animate-dropdown top-cart-row">
                        <div class="dropdown dropdown-cart" style="margin-left: 10px;">
                            <button class="btn btn-primary" type="button" data-hover="dropdown" data-toggle="dropdown">
                                <div class="basket "> <i class="fa-solid fa-user style_icon"></i> <?php echo $tenTK['tenKhachhang'] ?></div>
                            </button>
                            <ul class="dropdown-menu pages menuTK">
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-xs-12 col-menu">
                                            <ul class="links">
                                                <li class="item-menu"><a href="taikhoancuatoi.php">Tài khoản cá nhân</a></li>
                                                <li class="item-menu"><a href="donhang.php">Đơn hàng của tôi</a></li>
                                                <li class="item-menu"><a href="./logout.php">Đăng xuất</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <form action="" method="post" id="form1">
                            <div class="dropdown dropdown-cart">
                                <div class="items-cart-inner dropdown-toggle lnk-cart">
                                    <button class="btn btn-primary" type="button" id="offcanvasToggle">
                                        <a href="cart.php" style="color: #fff;">
                                            <div class="basket ">
                                                <i class="glyphicon glyphicon-shopping-cart style_icon"></i>
                                                Giỏ hàng
                                                <!-- <div class="soluongdonhang" id="data-container">
                                                    <span>
                                                        <?php
                                                        // $sqlcheckproduct = "SELECT count(*) as count FROM giohang WHERE maKhachHang = '$maKhachhang'";
                                                        // $resultcheckproduct = mysqli_query($conn, $sqlcheckproduct);
                                                        // $count = mysqli_fetch_assoc($resultcheckproduct);
                                                        // echo $count['count'];
                                                        ?>
                                                    </span>
                                                </div> -->
